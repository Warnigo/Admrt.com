            ...
            <div>
                        ...
                        <div class="flex flex-wrap items-center sm:-mx-3">
                            <div class="w-full md:w-1/2 md:px-3">
                                <div class="w-full  lg:max-w-lg  lg:space-y-8 xl:space-y-9 lg:pr-0 md:pb-0">
                                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                        About AdMrt
                                    </h1>
                                    <p class="mx-auto mt-3 md:mt-0 text-base font-light opacity-70 md:text-lg md:max-w-3xl">Admrt is a platform that streamlines the ad buying and selling process. Admrt will introduce a way for brands, services, and corporations to connect with variety of advertising and marketing spaces.  </p>
                                </div>
                            </div>
                    ...
                    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl ">
                        <div class="w-full md:w-2/3">
                            <div class="box-border relative w-full    text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0  ">
                                <img src={img2} class="text-center" alt='' />
                            </div>
                        </div>
                ...
                <section class="about-container-2 w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
                    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl ">
                        <div class="w-full md:w-2/3">
                            <div class="box-border relative w-full    text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0  ">
                                <img src={img4} class="text-center" alt='' />
                            </div>
                        </div>
                        <div class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
                            <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                ...
                                <p class="mx-auto text-sm font-light opacity-70 text-[#12141d]  sm:max-w-md lg:text-lg md:max-w-3xl">AdMrt simplifies the ad setup process, allowing you to quickly find ad spaces that fit your brand's targeted audience. Specializing in making usually inaccessible ad spaces accessible, AdMrt provides your brand with unique opportunities to reach new heights. Benefit from features that take care of complexities, making your AdMrt advertising experience seamless.</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="flex flex-wrap items-center sm:-mx-3">
                            <div class="text-center w-full md:w-1/2 md:px-3">
                                ...
                                <div class="w-full pb-6 space-y-6  lg:max-w-xl md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                    <img className="inline" src={img5} alt='' />
                                    <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-5xl">
                            ...
                            <div class="text-center w-full md:w-1/2">
                                <div class="w-full pb-6 space-y-6  lg:max-w-xl md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                    <img className="inline" src={img6} alt='' />
                                    <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-5xl">
                ...
                <div class="footer bg-[#F8FAFC]">
                    <div class=" mx-auto py-8 w-full ">
                        ...
                        <div class="flex items-center justify-center flex-wrap gap-4 p-4">
                            ...
                            <div class="card flex items-center justify-center flex-col w-full sm:w-72 h-full rounded-2xl">
                                <img src={img9} class="w-24 h-24 rounded-full object-cover transition duration-200 hover:scale-110" alt='' />
